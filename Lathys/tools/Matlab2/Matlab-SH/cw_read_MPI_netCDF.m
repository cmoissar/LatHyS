...
runname = '12_05_11_';
diagtime = 't00000';
dirname = '/home/seb/Bureau/Hybrid/CDF/';
...
t0 = uicontrol('Style','Text','String','Planet:',...
    'pos',[x0 y0+170 75 30],'parent',h,'HandleVisibility','off');
t1 = uicontrol('Style','Text','String',planetname,...
    'pos',[x0+80 y0+170 75 30],'parent',h,'HandleVisibility','off');
...
u131 = uicontrol('Style','Radio','String','Dn Neutral',...
    'pos',[x0+320. y0+15 95 30],'parent',h,'HandleVisibility','off');
...
set(h,'SelectionChangeFcn',{@selcbk,nc,h_f1,runname,diagtime,dirname,centr,radius});
