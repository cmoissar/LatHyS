...
!****************** TIME ***********************
 real(dp),save :: dt = 0.03_dp   !--Time step
 integer,save :: nhm = 200 !1000   !--Nombre de pas de temps maximum
...
!**************** PARTICLES ********************
 integer,save :: n_part_max = 120 !--Max number of particles in per cell at t=0
...
!**************** ENVIRONMENT ******************
 ...
 character(len=8),save :: planetname = "mars"
...
! field and ionosphere settings
 ...
 real(dp),save ::   resis  = 1.e-02_dp !--Valeur de la resistivité
 ...
 real(dp),save ::   t_iono_release    = 50. ! 50 !time during which the ionosphere is frozen

! IMF direction
 real(dp),save::   psi=90_dp
 real(dp),save::   phi=-57_dp
! B jovian G1 flyby
!real(dp),save :: psi = 135._dp
!real(dp),save :: phi = -90._dp
!real(dp),save :: psi = 90._dp
!real(dp),save :: phi = 90._dp

 !Planet settings
  integer,save  :: no_env_mag=0  !if 1 then no planetary magnetic field
  real(dp),save :: planet_ssl=180._dp !sub solar_longitude
