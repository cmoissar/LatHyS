...
write(string,'(3a)')  '<PopulationTemperature Units="eV" UnitsConversion="11605 > K">',trim(adjustl(string1)),'</PopulationTemperature>'
write(tmp_unit,'(A)') trim(adjustl(string))
...
write(tmp_unit,'(A)') '<PopulationFlowSpeed Units="km/s">0</PopulationFlowSpeed>'
if (LEN_TRIM(adjustl(atmosphere%species(i)%description)).ne.0) write(tmp_unit,'(A)') trim(adjustl(atmosphere%species(i)%description))
...
write(string,'(5a)') '<Name>',trim(adjustl(atmosphere%photo_reactions(i)%mother%name)),' + photon  = ',trim(adjustl(atmosphere%photo_reactions(i)%daughter%name)),' + e-</Name>'
write(tmp_unit,'(A)') trim(adjustl(string))
...
if (LEN_TRIM(adjustl(atmosphere%photo_reactions(i)%description)).ne.0) write(tmp_unit,'(A)') trim(adjustl(atmosphere%photo_reactions(i)%description))
write(tmp_unit,'(A)') '</InputProcess>'
enddo
!+++++ chex +++
do i=1,atmosphere%n_exc
write(tmp_unit,'(A)') '<InputProcess>'
write(string,'(5a)') '<Name>',trim(adjustl(atmosphere%exc_reactions(i)%ion%name)),'  =  ',trim(adjustl(atmosphere%exc_reactions(i)%neutral%name)),' Charge Exchange</Name>'
write(tmp_unit,'(A)') trim(adjustl(string))
...
if (LEN_TRIM(adjustl(atmosphere%exc_reactions(i)%description)).ne.0) write(tmp_unit,'(A)') trim(adjustl(atmosphere%exc_reactions(i)%description))
write(tmp_unit,'(A)') '</InputProcess>'
enddo
!+++++ ei +++
do i=1,atmosphere%n_ei
write(tmp_unit,'(A)') '<InputProcess>'
write(string,'(5a)') '<Name>',trim(adjustl(atmosphere%ei_reactions(i)%neutral%name)),' + e-  = ',trim(adjustl(atmosphere%ei_reactions(i)%ion%name)),' + 2e-</Name>'
write(tmp_unit,'(A)') trim(adjustl(string))
write(tmp_unit,'(A)') '<ProcessType>ElectronImpact</ProcessType>'
if (LEN_TRIM(adjustl(atmosphere%ei_reactions(i)%description)).ne.0) write(tmp_unit,'(A)') trim(adjustl(atmosphere%ei_reactions(i)%description))
write(tmp_unit,'(A)') '</InputProcess>'
enddo
