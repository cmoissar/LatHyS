...
!**************** PARTICLES ********************
 integer,save :: n_part_max = 100 !--Max number of particles in per cell at t=0
...
!**************** ENVIRONMENT ******************
 ...
 character(len=80) :: exospherename ="" 
 character(len=80) :: atmospherename ="" 
 character(len=80) :: ionospherename=""
!***********************************************
