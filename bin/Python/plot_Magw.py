...
if __name__ == '__main__' :
    ...
    liste = [ '../ncfiles/' ] 
             # './' + Cluster + '/2018-05-29.MClong.beta=0.3/ncfiles/',
             # './' + Cluster + '/2018-05-29.MClong.beta=0.7/ncfiles/',
             # './' + Cluster + '/2018-05-29.MClong.beta=0.9/ncfiles/',
             # './' + Cluster + '/2018-05-29.MClong.beta=1.1/ncfiles/',
             # './' + Cluster + '/2018-05-29.MClong.beta=1.3/ncfiles/' ]
    ...
    for filepath in liste :
        ...
        param_list = ['TMAX', 'DT', 'NTREG']
        file = '../Code/Soumission/launcher.sh'
        ...
        date = re.search('w_(.+?)_t', glob.glob(filepath+'Magw*_t00000*')[0]).group(1)
        ...
        for time in range (0,tmax+1,tstep):
            ...
            print('Reading file...') 
            #readNetcdfFile(filepath,file_Hsw,Hsw, x_plane=2/3)
            readNetcdfFile(filepath,file_mag,Magw, x_plane=2/3)
