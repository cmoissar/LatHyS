...
echo "Can I make use the york_launcher on the login shell?"
...
cp -rf $HOME/LatHyS/Lathys/src $RUNDIR/
cp -rf $HOME/LatHyS/Lathys/quiet_plasma $RUNDIR/
cp -rf $HOME/LatHyS/Lathys/diag $RUNDIR/
cp $HOME/LatHyS/bin/york_launcher.sh $RUNDIR/
...
cd ncfiles/
cp $HOME/LatHyS/bin/diagnostic_files/script_diag.sh ./
