...
contains
 ...
 !!
 !! FUNCTION
 !!   Periodic condition for densities or velocity arrays
 !!
 !! INPUTS
...
!  real(dp),allocatable :: r_line(:)
 ...
 subroutine b_boundary(Afield,ncx1,&
      &                by0,bz0,by1,bz1,ey_dm_conv,ez_dm_conv,&
      &                ey_dm_conv1,ez_dm_conv1,vxmean)

  use defs_arr3Dtype
  use defs_variable,only : bx0
  ...
  ey_dm_conv1 =  vxmean*bz1
  ez_dm_conv1 = -vxmean*by1
